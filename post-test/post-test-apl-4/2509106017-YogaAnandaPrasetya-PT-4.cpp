...
void lihatEntri(KebunRaya *ptrEntri, int jumlahEntri) {
    ...
    for (int i = 0; i < jumlahEntri; i++) {
        string tipeTanaman = (!(ptrEntri + i) -> klasifikasi) ? "Flora" : "Fauna"; 

        cout << "[Entri ke-" << i + 1 << "]" << endl;
        cout << "---------------------------------------------------------" << endl;
        cout << "ID Entri          : " << (ptrEntri + i) -> entriID << endl;
        cout << "Nama Umum         : " << (ptrEntri + i) -> namaUmum << endl;
        cout << "Nama Latin        : " << (ptrEntri + i) -> namaLatin << endl;
        cout << "Tipe              : " << tipeTanaman << endl; 
        cout << "Skala Konservasi  : " << (ptrEntri + i) -> skalaKonservasi << endl;
        cout << "Habitat Asli      : " << (ptrEntri + i) -> habitatAsli << endl; 
        cout << "Tahun Masuk       : " << (ptrEntri + i) -> tahunMasuk << endl; 
        cout << "Jumlah            : " << (ptrEntri + i) -> jumlah << endl;
        cout << "---------------------------------------------------------" << endl;
    } 
